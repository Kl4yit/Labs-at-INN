...
x_train, y_train = load_json("train_data.json")
x_test, y_test = load_json("test_data.json")
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
n1 = 5  # выбрали номер от 0 до 60000
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# выпрямляем массив, чтобы он из квадратного превратился в линейный
